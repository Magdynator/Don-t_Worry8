...
<html lang="en">
  ...
  <div class="container">
    ...
    <h1 Style="text-align: center; background-color:rgb(210, 210, 210);">Game 4</h1><br><br>
            ...
            <tr scope="row">
                      ...
                      <td><h2 class="post-title">
                        {{ $game->game_4}}
                         ...
                         <td>  
                          <button type="button" class="btn btn-success" onclick="window.location='{{ url("admin2/". $game->team_id)."/edit/games" }}'">edit</button>
                      </td>
            </tr>
        </tbody>
      ...
      <div class="table-responsive">
        ...
        <table class="table table-striped custom-table">
      <h1 Style="text-align: center; background-color:rgb(210, 210, 210);">Game 5</h1><br><br>
